...
public class FiniteAutomaton implements Serializable {
    ...
    protected ArrayList<Character> alphabet = new ArrayList<>();//字母表

    protected LabeledDirectedGraph<State> transitTable = new LabeledDirectedGraph<>();//状态转换表

    protected State startState;//开始状态
    ...
    public void renumberSID(){
        ...
        while (bfi.hasNext()) {
            ...
            i++;
        }//看样子来说，像是为已经制作好的NFA图结构用BFS的方式标上每个结点的序号，但是这不是局部变量吗，不知道有什么用
    }
